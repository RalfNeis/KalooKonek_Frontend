    ...
    return (
        <div className='bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden w-full'>
            ...
            <div className="flex items-center justify-between px-8 py-4 border-b border-gray-50">
                ...
                <button className="text-[11px] font-bold text-[#A0AEC0] hover:text-sky-600 transition-colors uppercase tracking-widest cursor-pointer border-none bg-transparent p-0">
                    CLEAR
                </button>
            </div>
            ...
            <div className='flex flex-col md:flex-row'>
                <div className='w-full md:w-1/3 p-10 flex flex-col items-center text-center'>
                    <div className='relative w-28 h-28 mb-6'>
                        ...
                        <span className="absolute bottom-2 right-2 block h-5 w-5 rounded-full ring-4 ring-white bg-sky-500" />
                    </div>
                ...
                <div className='flex-1 p-10 bg-[#FAFAFA] border-l border-gray-50'>
                    ...
                    <div className='mt-10 flex justify-end gap-8 items-center'>
                        ...
                        {/* FIXED: Changed to Medical Staff Blue */}
                        <button className="bg-[#0284c7] text-white px-8 py-3 rounded-xl text-[16px] font-bold shadow-md shadow-sky-100 hover:bg-[#0369a1] transition-all active:scale-95 cursor-pointer">
                            Save Record
                        </button>
                    </div>
                </div>
