  ...
  return (
    <>
      ...
      <div style={{ ...styles.page, background: darkMode ? "#1a1a1a" : "#f4f5f7" }}>
        ...
        {/* NAVBAR */}
        <nav style={{ ...styles.navbar, background: darkMode ? "#1e1e1e" : "#fff", borderBottomColor: darkMode ? "#333" : "#e8e8e8" }}>
          {/* Brand */}
          ...
          <div style={styles.navLinks}>
            {NAV_ITEMS.map(item => (
              <NavLink key={item} label={item} active={activeNav === item} onClick={() => setActiveNav(item)} />
            ))}
          </div>
          ...
          <div style={styles.navRight}>
            <span style={{
              ...
              background: "#e8f0fe", color: "#3366cc", padding: "3px 8px", borderRadius: 99,
            }}>
              v2.0.0-beta
            </span>
            ...
            <button style={{ position: "relative", background: "none", border: "none", cursor: "pointer", padding: 4 }}>
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke={darkMode ? "#ccc" : "#555"} strokeWidth="2">
                <path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"/>
                <path d="M13.73 21a2 2 0 0 1-3.46 0"/>
              </svg>
              <span style={{
                position: "absolute", top: 0, right: 0,
                width: 8, height: 8, background: "#cc2222",
